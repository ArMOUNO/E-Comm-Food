const NewOrderDesign = ({ onBuy, item, details, img, price }) => {
    return (
        <>
            <div className="relative bg-gradient-to-b from-[#ffffff] via-[#ffffffbf] to-[#fbada380] h-[200px] md:w-[180px] w-[120px] flex flex-col items-center justify-center rounded-lg my-4">
                <div className="absolute md:top-[-60px] top-[-30px] bg-gradient-to-t from-[#ffffff] via-[#ffffffbf] to-[#ea7f7f80] md:w-[150px] md:h-[150px] w-[130px] h-[130px] rounded-full flex justify-center items-center">
                    <div className="bg-white flex items-center justify-center md:w-[130px] md:h-[130px] w-[110px] h-[110px] rounded-full">
                        <img className="md:w-[120px] md:h-[120px] w-[100px] h-[100px] rounded-full p-2" src={img} alt="" />
                    </div>
                </div>
